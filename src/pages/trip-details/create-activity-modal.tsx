...
export function CreateActivityModal({
    ...
    async function createActivity(event: FormEvent<HTMLFormElement>) {
        ...
        console.log(`[Debug] activityID: ${response.data.activityId}`)
        closeCreateActivityModal()

        window.document.location.reload()
        {/* Quando adiciona-se uma nova atividade, o componente de listar atividades, activities.tsx, não é recarregado automaticamente. */}
    }
